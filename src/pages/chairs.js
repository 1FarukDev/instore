          ...
          return (
            <div className="">
              ...
              <div className="w-1/3 h-96">
                <Image src={cha.image} width={500} height={200} className="w-full h-full border-2 border-red-200" />
              </div>
            </div>
          );
        })}
