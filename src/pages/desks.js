    ...
    <section className="mt-6">
      <header className="relative w-full ">
        ...
        <div className="absolute top-1/3 flex left-6 items-center">
          ...
          <span className="text-white font-bold text-3xl pl-4">Desks</span>
        </div>
      </header>
